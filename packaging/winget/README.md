...
MarkerOnPlus is already discoverable through the Microsoft Store source:

```powershell
winget search --name MarkerOnPlus --accept-source-agreements
...
MarkerOnPlus  9N6623X973JV Unknown   msstore
```
...
- Package identifier: `ifer47.MarkerOnPlus`
- Package name: `MarkerOnPlus`
- Publisher: `ifer47`
- Homepage: `https://github.com/ifer47/markeronplus`
- License: `MIT`
- Release URL: `https://github.com/ifer47/markeronplus/releases/tag/v1.0.0`
- Installer URL: `https://github.com/ifer47/markeronplus/releases/download/v1.0.0/MarkerOnPlus_1.0.0_x64_zh-CN.msi`
