...
| :--- | :--- | :--- |
| Windows x64 | [MarkerOn_0.1.0_x64-setup.exe](https://github.com/ifer47/markeron/releases/download/v0.1.0/MarkerOn_0.1.0_x64-setup.exe) | NSIS installer (recommended) |
| Windows x64 | [MarkerOn_0.1.0_x64_zh-CN.msi](https://github.com/ifer47/markeron/releases/download/v0.1.0/MarkerOn_0.1.0_x64_zh-CN.msi) | MSI installer |
...
You can also visit the [Releases page](https://github.com/ifer47/markeron/releases/tag/v0.1.0) for all versions and changelogs.
