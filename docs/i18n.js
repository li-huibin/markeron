(function () {
  const STORAGE_KEY = 'markeronplus-lang';
  ...
  const messages = {
    en: {
      'meta.title': 'MarkerOnPlus - Lightweight Screen Annotation Tool',
      'meta.description':
        'MarkerOnPlus is a lightweight open-source screen annotation tool with click-through mode, whiteboard mode, and keyboard-first drawing for Windows, macOS, and Linux.',
      'meta.keywords':
        'screen annotation tool, ZoomIt alternative, Epic Pen alternative, desktop whiteboard, Tauri app, screen drawing',
      'meta.ogTitle': 'MarkerOnPlus - Lightweight Screen Annotation Tool',
      'meta.ogDescription':
      ...
      'nav.brandAria': 'MarkerOnPlus home',
      ...
      'bottom.title': 'Download MarkerOnPlus or read the FAQ.',
      ...
      'bottom.faq1Title': 'Is MarkerOnPlus a ZoomIt alternative?',
      ...
      'footer.license': 'MarkerOnPlus is open source under the MIT License.',
      'footer.feedback': 'Feedback and issues',
    },
    'zh-CN': {
      'meta.title': 'MarkerOnPlus - 轻量级屏幕标注工具',
      'meta.description':
        'MarkerOnPlus 是一款轻量级开源屏幕标注工具，支持穿透模式、白板模式与快捷键优先绘制，适用于 Windows、macOS 和 Linux。',
      'meta.keywords':
        '屏幕标注工具, ZoomIt 替代, Epic Pen 替代, 桌面白板, Tauri 应用, 屏幕绘画',
      'meta.ogTitle': 'MarkerOnPlus - 轻量级屏幕标注工具',
      'meta.ogDescription':
        '在桌面任意位置绘画、高亮与标注。穿透模式下标注保持可见，同时可操作下层应用。',
      'skip': '跳到主要内容',
      'nav.aria': '主导航',
      'nav.brandAria': 'MarkerOnPlus 首页',
      'nav.linksAria': '产品链接',
      'nav.features': '功能',
      'nav.download': '下载',
      'nav.faq': '常见问题',
      ...
      'showcase.toolsAlt': 'MarkerOnPlus 标注工具',
      'showcase.toolsCaption': '画笔、荧光笔、箭头、形状、橡皮擦、文字与颜色。',
      'showcase.settingsTitle': '设置面板',
      'showcase.settingsAlt': 'MarkerOnPlus 设置面板',
      ...
      'shortcuts.board': '白板',
      'bottom.eyebrow': '开始使用',
      'bottom.title': '下载 MarkerOnPlus 或查看常见问题。',
      ...
      'bottom.faq1Title': 'MarkerOnPlus 能替代 ZoomIt 吗？',
      ...
      'footer.license': 'MarkerOnPlus 基于 MIT 协议开源。',
